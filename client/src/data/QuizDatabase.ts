	...
	quizzes: [
		{
			...
			files: [
				...
				{
					path: "./audio/me18.mp3",
					title: "Hava Netze Bamachol/El Ginat Egoz/Hora Eylat (Let Us Go to the Dance/To the Garden of Walnut/The Hora of Eylat)",
		...
		},
		{
			...
			files: [
				...
				},
				{
					...
					title: "Excerpt from Chor Poreche Babur Bagane [A thief fell upon the master's garden]",
		...
		},
		{
			...
			files: [
				...
				{
					path: "./audio/j6.mp3",
					title: "Yatsuhashi Kengyo (1614-1685): Rokudan no shirabe [Study in Six Sections]",
					countryOfOrigin: "Japan",
					attributes: [],
				},
				{
